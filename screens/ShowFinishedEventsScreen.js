...
class ShowFinishedEventsScreen extends Component {
  constructor() {
    super();
    this.state = {
      data: [],
  ...
  componentDidMount() {
    this.unsubscribe = this.props.navigation.addListener("focus", async () => {
      ...
      await axios
        ...
        .catch((error) => {
          console.log(
            "ShowFinishedEventsScreen (get finished events error): " +
...
ShowFinishedEventsScreen.contextType = TokenContext;
...
export default ShowFinishedEventsScreen;
